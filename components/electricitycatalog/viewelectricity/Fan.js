...
const Fan = ({ id, viewElectricProduct, setViewElectricProduct }) => {
              ...
              <div className="view-mdl only-view">
                ...
                <div className="row">
                  ...
                  <div className="d-flex mb-2">
                    ...
                    <input
                      className="form-control"
                      value={viewElectricProduct?.company_url}
                    />

                    <div className="actions-bttns ms-2">
                      <Link href={viewElectricProduct?.company_url || "#"}>
                        <span>
                          {" "}
                          <i className="fe fe-link "></i>
                        </span>
                  ...
                  <div className="col-lg-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        className="form-control"
                        //  value="4.1"
                        value={viewElectricProduct?.model_name}
                        readonly
                      />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        className="form-control"
                        //  value="4.1"
                        value={viewElectricProduct?.price_range}
                        readonly
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        className="form-control"
                        //  value="4.1"
                        value={viewElectricProduct?.price_on_company_site}
                        readonly
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        className="form-control"
                        //  value="4.1"
                        value={viewElectricProduct?.blade_length}
                        readonly
                      />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        className="form-control"
                        //  value="4.1"
                        value={viewElectricProduct?.remote}
                        readonly
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        ...
                        //  value="300.9"
                        value={
                          viewElectricProduct?.comments ?? "Not Available"
                        }
                        readonly
                      />
                    </div>
