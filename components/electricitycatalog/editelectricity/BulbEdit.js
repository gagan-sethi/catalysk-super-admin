...
const TubeLightEdit = ({
  ...
  const validationSchema = Yup.object().shape({
    ...
    product_link: Yup.string().required("Product link is required"),
    comments: Yup.string(),
  ...
  console.log("viewElectricProduct", viewElectricProduct.colour);
  ...
  const handleEdit = async () => {
    ...
    formik.validateForm().then(async (errors) => {
      if (Object.keys(errors).length === 0) {
        ...
        postdata = { ...formik?.values, product_link: formik?.values.product_link};
  ...
  console.log("allErrors",formik.errors)
  ...
  useEffect(() => {
    console.log("myProductLink",viewElectricProduct?.product_link)
    if (viewElectricProduct) {
      formik.setValues({
        brand: viewElectricProduct?.brand || "",
        product_link:Array.isArray(viewElectricProduct?.product_link)?viewElectricProduct?.product_link[0] :viewElectricProduct?.product_link,
        ...
        // colour: viewElectricProduct.colour || [""],
        colour: Array.isArray(viewElectricProduct.colour)
        ? viewElectricProduct.colour
        : [viewElectricProduct.colour] || [""],
                    ...
                    <div className="d-flex align-items-end mb-3 gap-2">
                      <div className="form-group flex-grow-1">
                        ...
                        <input  style={{ pointerEvents: 'auto', backgroundColor: 'white' }} type="text"
                          ...
                          {...formik.getFieldProps("product_link")}
                        />
                      ...
                      <Link href={formik.values.product_link ?? "#"} target="_blank" rel="noopener noreferrer">
