              ...
              <table className="table table-striped">
                ...
                <tbody>
                  <tr>
                    <td scope="row">01</td>
                    <td>
                      <div className="faq-ans">What is the return policy?</div>
                    </td>
                    <td>
                      <div className="faq-ans">
                        Our return policy allows you to return products within
                        30 days of purchase. The items must be unused and in
                        their original packaging. Please visit our returns page
                        for more details.
                      </div>
                    </td>
