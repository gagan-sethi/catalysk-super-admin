...
export const BorderSpinner = () => (
  <Spinner animation="border" class="spinner-border spinner-border-sm" role="status">
...
// Growing Spinner with Colors
export const GrowColors = () => (
  <>
...
// Centered Spinner
export const PlacementCenterSpinner = () => (
...
export const PlacementLoadingSpinner = () => (
...
export default {
  ...
  GrowColors,
  AlignmentSpinner,
  PlacementCenterSpinner,
  PlacementLoadingSpinner,
  FloatsSpinner,
  TextAlignSpinner,
  SizeSpinners,
  StyleCSSSpinner,
