...
const CorporateCustomerGeneralInfo = () => {
  return (
    <>
              ...
              <Row className='mb-3'>
                ...
                <Col md={8} xs={12} className=''>
                  <textarea
                    ...
                    value='1234 Main Street, Suite 100 San Francisco, CA 94105 USA'
                  ></textarea>
                </Col>
              </Row>
...
export default CorporateCustomerGeneralInfo
